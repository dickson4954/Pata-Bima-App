...
const LastExpenseInsuranceScreen1 = () => {
  const navigation = useNavigation();

  const handleSelect = (type) => {
    if (type === 'Individual') {
      navigation.navigate('LastExpenseIndividualForm');
    } else {
      navigation.navigate('LastExpenseCorporateForm');
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Heading: Select Policy Type */}
      <Text style={styles.subHeading}>Select Policy Type</Text>
...
export default LastExpenseInsuranceScreen1;
